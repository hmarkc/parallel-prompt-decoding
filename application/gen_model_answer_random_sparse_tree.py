...
if __name__ == "__main__":
    ...
    if '13b' in args.model_path:
        raise ValueError("13b model is not supported for now")
    else: 
        from prompt.inference.random_sparse_trees_3_7b import *
        args.tree_length = eval("random_sparse_trees_" + args.tree_length)
        print('Using random sparse trees 7b', args.tree_length, len(args.tree_length[3]))
